...
2. `02_modelling_space.ipynb` - restrict search to transformations, tastes, covariates, attributes, and covariate levels.
3. `03_your_own_datasets.ipynb` - understand bundled datasets and prepare your own CSV/schema.
